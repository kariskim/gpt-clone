...
}, {title: "Show me a code snippet", desc: "of a website's sticky header"}, {
    title: "Explain this code",
    desc: "cat config.yaml | awk NF"
}, {title: "Brainstorm incentives", desc: "for a customer loyalty program in a small bookstore"}]

function ContentsMiddle({alreadyChatted, conversations}: {alreadyChatted: boolean, conversations: []}) {
                ...
                : (
                    <>
                        <div className="greeting">
                            <div className="icon gizmo">
                                <svg width="41" height="41" viewBox="0 0 41 41" fill="none"
                                     xmlns="http://www.w3.org/2000/svg" className="h-2/3 w-2/3" role="img">
                        ...
                        <div className="cards">
                            {cardInfos.map((card, idx) => <div className="card"
                                                               onMouseEnter={() => handleHover(idx, true)}
                                                               onMouseLeave={() => handleHover(idx, false)} key={idx}>
